...
MainNavbarDom.innerHTML = htmlMainNavData;
    ...
    const YuriDom = document.getElementById('YuriData');
    ...
    htmlContent += `
        <div class="col-md-2">
            <div class="list-group">
                <a href="Yuri.html?id=${ID}&BookType=All" class="list-group-item">All</a>
                <a href="Yuri.html?id=${ID}&BookType=Manga" class="list-group-item">Manga</a>
                <a href="Yuri.html?id=${ID}&BookType=นิยาย" class="list-group-item">นิยาย</a>
                <a href="Yuri.html?id=${ID}&BookType=Light Novel" class="list-group-item">Light Novel</a>
    ...
    let YuriBooks = response.data.filter(book => book.SubType === 'Yuri' );
    if (bookType !== 'All') {
        YuriBooks = YuriBooks.filter(book => book.BookType === bookType);
    }
    
    for (let i = 0; i < 12 && i < YuriBooks.length; i++) {
        let book = YuriBooks[i];    
        htmlContent += `
