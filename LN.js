...
MainNavbarDom.innerHTML = htmlMainNavData;
    ...
    const LNDom = document.getElementById('LightNovelData');
    let htmlContent = '<div class="row" style="margin-top: 20px;">';

    htmlContent += `
        <div class="col-md-2">
            <div class="list-group">
                <a href="LN.html?id=${ID}&subType=All" class="list-group-item">All</a>
                <a href="LN.html?id=${ID}&subType=Romantic" class="list-group-item">Romantic</a>
                <a href="LN.html?id=${ID}&subType=Crime" class="list-group-item">Crime</a>
                <a href="LN.html?id=${ID}&subType=Action" class="list-group-item">Action</a>
                <a href="LN.html?id=${ID}&subType=Fantasy" class="list-group-item">Fantasy</a>
                <a href="LN.html?id=${ID}&subType=Yaoi" class="list-group-item">Yaoi</a>
                <a href="LN.html?id=${ID}&subType=Yuri" class="list-group-item">Yuri</a>
            </div>
        </div>
    `;
    ...
    let LNBooks = response.data.filter(book => book.BookType === 'Light Novel');
    if (subType !== 'All') {
      LNBooks = LNBooks.filter(book => book.SubType === subType);
    }
    
    for (let i = 0; i < 12 && i < LNBooks.length; i++) {
        let book = LNBooks[i];    
        htmlContent += `
