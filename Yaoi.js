...
const MangaBook = async () => {
    ...
    const bookType = urlParams.get('BookType') || 'All';
...
MainNavbarDom.innerHTML = htmlMainNavData;
    ...
    const YaoiDom = document.getElementById('YaoiData');
    ...
    htmlContent += `
        <div class="col-md-2">
            <div class="list-group">
                <a href="Yaoi.html?id=${ID}&BookType=All" class="list-group-item">All</a>
                <a href="Yaoi.html?id=${ID}&BookType=Manga" class="list-group-item">Manga</a>
                <a href="Yaoi.html?id=${ID}&BookType=นิยาย" class="list-group-item">นิยาย</a>
                <a href="Yaoi.html?id=${ID}&BookType=Light Novel" class="list-group-item">Light Novel</a>
    ...
    let YaoiBooks = response.data.filter(book => book.SubType === 'Yaoi' );
    if (bookType !== 'All') {
        YaoiBooks = YaoiBooks.filter(book => book.BookType === bookType);
    }
    
    for (let i = 0; i < 12 && i < YaoiBooks.length; i++) {
        let book = YaoiBooks[i];    
        htmlContent += `
